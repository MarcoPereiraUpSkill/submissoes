...
-- Mostrar o nic e o nome dos atletas e o nome das competições em que participaram
...
-- Obter o nic e o nome dos atletas e o número de competições em que participaram de
-- atletas que participaram em mais que 2 competições
-- ordenado por número de competições e nome do atleta
select * from 
(
    select b.nic, b.nome, a.competicoes
...
-- Obter os registos de atletas que não têm correspondência na tabela de tipos de atletas
select *
    from Atleta
